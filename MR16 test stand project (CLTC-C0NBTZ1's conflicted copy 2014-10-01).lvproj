...
<Project Type="Project" LVVersion="13008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="200595" Type="Folder">
			<Item Name="programmatically writting a 2D array to a multicolumn listbox.vi" Type="VI" URL="../200595.llb/programmatically writting a 2D array to a multicolumn listbox.vi"/>
			<Item Name="resize 2D string array.vi" Type="VI" URL="../200595.llb/resize 2D string array.vi"/>
		</Item>
		<Item Name="Stabilize and measure" Type="Folder">
			<Item Name="daq init all.vi" Type="VI" URL="../Stabilize and measure/daq init all.vi"/>
			<Item Name="daq init.vi" Type="VI" URL="../Stabilize and measure/daq init.vi"/>
			<Item Name="LM79 Stabilization.vi" Type="VI" URL="../Stabilize and measure/LM79 Stabilization.vi"/>
			<Item Name="Parse for stabilization power.vi" Type="VI" URL="../Stabilize and measure/Parse for stabilization power.vi"/>
			<Item Name="Stabilize and Measure.vi" Type="VI" URL="../Stabilize and measure/Stabilize and Measure.vi"/>
			<Item Name="Start Data Acquisition.vi" Type="VI" URL="../Stabilize and measure/Start Data Acquisition.vi"/>
		</Item>
		<Item Name="Test VIs" Type="Folder">
			<Item Name="custom scale test - init.vi" Type="VI" URL="../Test VIs/custom scale test - init.vi"/>
			<Item Name="custom scale test.vi" Type="VI" URL="../Test VIs/custom scale test.vi"/>
			<Item Name="Test - LM 79 stabilization.vi" Type="VI" URL="../Test VIs/Test - LM 79 stabilization.vi"/>
			<Item Name="test sync acq.vi" Type="VI" URL="../Test VIs/test sync acq.vi"/>
			<Item Name="test TDMS.vi" Type="VI" URL="../Test VIs/test TDMS.vi"/>
			<Item Name="test waveform output.vi" Type="VI" URL="../Test VIs/test waveform output.vi"/>
		</Item>
		<Item Name="Controls" Type="Folder">
			<Item Name="Data Cluster.ctl" Type="VI" URL="../Controls/Data Cluster.ctl"/>
			<Item Name="data to write.ctl" Type="VI" URL="../Controls/data to write.ctl"/>
			<Item Name="data.ctl" Type="VI" URL="../Controls/data.ctl"/>
			<Item Name="Dim level.ctl" Type="VI" URL="../Controls/Dim level.ctl"/>
			<Item Name="Power Values.ctl" Type="VI" URL="../Controls/Power Values.ctl"/>
			<Item Name="Stabilization.ctl" Type="VI" URL="../Controls/Stabilization.ctl"/>
			<Item Name="StateMachineStates 1.ctl" Type="VI" URL="../Controls/StateMachineStates 1.ctl"/>
			<Item Name="Test Case.ctl" Type="VI" URL="../Controls/Test Case.ctl"/>
			<Item Name="timer command.ctl" Type="VI" URL="../Controls/timer command.ctl"/>
			<Item Name="waveform display.ctl" Type="VI" URL="../Controls/waveform display.ctl"/>
		</Item>
		<Item Name="MR16 Test Stand - main.vi" Type="VI" URL="../MR16 Test Stand - main.vi"/>
		<Item Name="MR16 test stand project.aliases" Type="Document" URL="../MR16 test stand project.aliases"/>
		<Item Name="arrange waveforms.vi" Type="VI" URL="../arrange waveforms.vi"/>
		<Item Name="determine test case.vi" Type="VI" URL="../determine test case.vi"/>
		<Item Name="display waveforms.vi" Type="VI" URL="../display waveforms.vi"/>
		<Item Name="error handler.vi" Type="VI" URL="../error handler.vi"/>
		<Item Name="find indices.vi" Type="VI" URL="../find indices.vi"/>
		<Item Name="get cluster names.vi" Type="VI" URL="../get cluster names.vi"/>
		...
		<Item Name="set dimmer.vi" Type="VI" URL="../set dimmer.vi"/>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="arranged waveforms.ctl" Type="VI" URL="../Controls/arranged waveforms.ctl"/>
		</Item>
